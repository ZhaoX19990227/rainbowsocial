...
type Config struct {
	...
	RemoteUploadEnabled  bool
	RemoteUploadHost     string
	RemoteUploadPort     int
	RemoteUploadUser     string
	RemoteUploadPassword string
...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		RemoteUploadEnabled:  getEnvAsBool("REMOTE_UPLOAD_ENABLED", false),
		RemoteUploadHost:     getEnv("REMOTE_UPLOAD_HOST", ""),
		RemoteUploadPort:     getEnvAsInt("REMOTE_UPLOAD_PORT", 22),
		RemoteUploadUser:     getEnv("REMOTE_UPLOAD_USER", ""),
		RemoteUploadPassword: getEnv("REMOTE_UPLOAD_PASSWORD", ""),
		RemoteUploadDir:      getEnv("REMOTE_UPLOAD_DIR", ""),
	}
